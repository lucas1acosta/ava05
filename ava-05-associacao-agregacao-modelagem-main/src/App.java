...
class App {
  public static void main(String[] args) {
    ...
    System.out.println(((Livro) meuPerfil.getListaDesejos("Minha lista").getLivro(0)).getAutor().getNome()); // Marcelo
    System.out.println(((Livro) meuPerfil.getListaDesejos("Minha lista").getLivro(0)).getAutor().getNome().equals("Marcelo"));
    // O sobrenome do autor do terceiro livro da lista de desejos Comprar Urgente
    System.out.println(((Livro) meuPerfil.getListaDesejos("Comprar Urgente").getLivro(2)).getAutor().getSobrenome());
    System.out.println(((Livro) meuPerfil.getListaDesejos("Comprar Urgente").getLivro(2)).getAutor().getSobrenome().equals("Sagan"));
    // Obtendo o nome da editora do terceiro livro da lista de desejos Comprar Urgente
    System.out.println(((Livro) meuPerfil.getListaDesejos("Comprar Urgente").getLivro(2)).getEditora().getNome());
    System.out.println(((Livro) meuPerfil.getListaDesejos("Comprar Urgente").getLivro(2)).getEditora().getNome().equals("Companhia de Bolso"));

    // Obtendo o título do segundo livro da segunda lista de desejos
    System.out.println(((Livro) meuPerfil.getListaDesejos(1).getLivro(1)).getTitulo().equals("Criação imperfeita"));
